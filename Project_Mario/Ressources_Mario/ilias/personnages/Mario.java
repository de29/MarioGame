...
public class Mario extends Personnage {
	...
	public void contact(Objet objet) {		
		...
		}else if(super.contactDessus(objet) == false && this.isSaut() == false){
	...
	@Override
    public boolean contact(Personnage personnage) {		
